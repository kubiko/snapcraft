...
class TestPluginInitrd:
    ...
    def test_check_configuration_simple(self, setup_method_fixture, new_dir):
        ...
        assert opt.initrd_ubuntu_core_initramfs_deb is None
    ...
    def test_check_get_build_command_comp_modules_modules_configured_overlay(
        ...
        plugin = setup_method_fixture(
            ...
            properties={
                ...
                "initrd-ubuntu-core-initramfs-deb": "${CRAFT_STAGE}/ubuntu-core-initramfs_my_build.deb",
            },
        )
...
_setup_initrd_chroot_custom_u_c_i_fnc = [
    _setup_initrd_chroot_fnc[0].replace(
        "ubuntu-core-initramfs", "/ubuntu-core-initramfs_custom.deb"
    )
]
